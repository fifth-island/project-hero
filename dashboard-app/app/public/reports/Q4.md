...
![Pollutant distributions and daily AQI](./figures/q4_pollutant_distributions.png)
...
![Hourly pollutant patterns by day type](./figures/q4_hourly_patterns.png)
...
![Daily AQI stacked by pollutant](./figures/q4_daily_aqi_stacked.png)
...
![Correlation matrix: pollutants and environmental variables](./figures/q4_correlation_matrix.png)
...
![Weather-pollutant scatter matrix](./figures/q4_weather_scatter.png)
...
![Spatial variation by site](./figures/q4_spatial_variation.png)
...
![Pollution rose by wind direction](./figures/q4_pollution_rose.png)
...
![Site × hour heatmaps for NO₂ and PM2.5](./figures/q4_site_hour_heatmap.png)
...
![Daily pollutant trends, z-score normalized](./figures/q4_daily_trends.png)
