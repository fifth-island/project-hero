...
![Site Bias Map](./figures/q1_bias_map.png)
...
![PM2.5 distributions by monitor and density](./figures/q1_pm25_distributions.png)

### Purple Air PM2.5 by Site

![PA PM2.5 by site boxplot](./figures/q1_pa_by_site.png)

### Reference Monitor Agreement

![DEP Chinatown vs DEP Nubian scatter](./figures/q1_ref_crosscheck.png)
...
![Scatter matrix: PA vs 3 references](./figures/q1_scatter_matrix.png)

### Bland-Altman Agreement

![Bland-Altman: PA vs DEP Chinatown](./figures/q1_bland_altman.png)
...
![Before/after calibration](./figures/q1_calibration.png)
...
![Time series with AQI bands](./figures/q1_timeseries_aqi.png)
...
![Rush-hour analysis: PM2.5 and bias](./figures/q1_rush_hour_analysis.png)

### Rush-Hour Bias by Site

![Rush vs non-rush bias by site](./figures/q1_rush_hour_bias_by_site.png)
...
![MSD heatmap by day and site](./figures/q1_msd_day_of_week.png)

![MSD and bias by day of week](./figures/q1_dow_analysis.png)
...
![Bias by PM2.5 concentration bins](./figures/q1_bias_by_concentration.png)
...
![Hourly bias with rush-hour shading](./figures/q1_diurnal_bias.png)
...
![Daily PM2.5 and bias](./figures/q1_daily_timeseries.png)
...
![Violin plots of bias by site](./figures/q1_site_violins.png)

### Meteorological Drivers: Temperature × Humidity

![Bias heatmap: temp vs humidity](./figures/q1_bias_temp_rh_heatmap.png)

Highest bias at high temperature (85–95°F) + moderate humidity (60–70%): +4.6 µg/m³.

### Wind Direction Effects

![Polar plot: bias by wind direction](./figures/q1_wind_direction_bias.png)
