...
![Temperature distribution by monitor](./figures/q2_temp_distributions.png)
...
![Kestrel temperature by site — urban heat island variability](./figures/q2_kes_by_site.png)
...
![Reference monitor cross-check: WS vs DEP Nubian](./figures/q2_ref_crosscheck.png)
...
![Kestrel vs each reference with OLS regression](./figures/q2_scatter_matrix.png)
...
![Bland-Altman analysis: Kestrel vs DEP Nubian and WS](./figures/q2_bland_altman.png)
...
![Diurnal temperature cycle — rooftop thermal mass effect](./figures/q2_diurnal_pattern.png)
...
![Cross-correlation: Kestrel vs phase-shifted WS](./figures/q2_lag_correlation.png)
...
![Temperature bias distribution by site](./figures/q2_site_violins.png)
...
![Temperature bias by temp × humidity interaction](./figures/q2_bias_temp_rh_heatmap.png)
...
![Bias by wind direction — polar plots](./figures/q2_wind_direction_bias.png)
...
![Daily mean temperature: Kestrel vs references](./figures/q2_daily_timeseries.png)
...
![Temperature bias by site × hour of day](./figures/q2_site_hour_heatmap.png)
...
![Land-use vs site temperature and bias](./figures/q2_landuse_temp.png)
...
![Rolling 7-day correlation stability](./figures/q2_rolling_stability.png)
...
![Temperature vs WBGT relationship](./figures/q2_temp_vs_wbgt.png)
